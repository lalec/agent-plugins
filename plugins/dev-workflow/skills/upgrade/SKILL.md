...
- `.claude/commands/code.md` and `fix.md` contain "Single gate" (one AskUserQuestion for confirm + verify + regression) and the stash-at-entry wording; their close-out contains "Restore stashed WIP"
