...
- [ ] `.claude/commands/code.md` and `fix.md` Step 0.5 is a **single** AskUserQuestion call (confirm + verify + regression together — not three sequential gates); Step 0 stashes pre-existing WIP; the close-out restores it
